function solve() {
    ...
    let openArea = document.querySelectorAll('section')[1].querySelectorAll('div')[1];
    let progressArea = document.querySelectorAll('section')[2].querySelectorAll('div')[1];
    let completeArea = document.querySelectorAll('section')[3].querySelectorAll('div')[1];
